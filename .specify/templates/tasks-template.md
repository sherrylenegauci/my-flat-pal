...
**Tests**: Tests are MANDATORY per Constitution Principle III (Test-First, NON-NEGOTIABLE). Every user story MUST have test tasks, they MUST be listed before the implementation tasks they cover, and they MUST be written and observed failing before that implementation begins.
...
- [ ] T010 [P] [US1] Behaviour test for [acceptance scenario] in tests/[area]/[name].test.ts
